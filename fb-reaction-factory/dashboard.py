...
</style></head><body><div class="wrap"><div class="brand">Reaction Factory</div><div class="sub">Paste one URL. Edit once. Publish where you choose.</div>
<div class="card" style="margin-bottom:16px;border-color:#6d5dfc"><div style="display:flex;align-items:center;justify-content:space-between;gap:14px;flex-wrap:wrap"><div><b style="font-size:18px">🎮 D6x8 Gamer · Gaming 35/65</b><div style="color:#8d99aa;font-size:12px;line-height:1.5;margin-top:5px">Saved gaming reaction on top 35% + gameplay URL on bottom 65%. Publishes only to D6x8 Gamer Facebook and YouTube with 5 gaming tags.</div></div><a class="link" href="/gaming/">Open Gaming 35/65</a></div></div>
<div class="card">
